...
# Esse script se diferencia do outro porque está usando WAIT ao inves de SLEEP
...
time CUDA_VISIBLE_DEVICES={devices[0]} ./mig >> /home/pabloh/2025/saidas/compute-{maquina}/{tamanho_mig}/{benchmark_no_size}/mig-{benchmark_no_size}-{index}-{devices[0]} &
MIG_PID_0=$!

time CUDA_VISIBLE_DEVICES={devices[1]} ./mig >> /home/pabloh/2025/saidas/compute-{maquina}/{tamanho_mig}/{benchmark_no_size}/mig-{benchmark_no_size}-{index}-{devices[1]} &
MIG_PID_1=$!

time CUDA_VISIBLE_DEVICES={devices[2]} ./mig >> /home/pabloh/2025/saidas/compute-{maquina}/{tamanho_mig}/{benchmark_no_size}/mig-{benchmark_no_size}-{index}-{devices[2]} &
MIG_PID_2=$!

time CUDA_VISIBLE_DEVICES={devices[3]} ./mig >> /home/pabloh/2025/saidas/compute-{maquina}/{tamanho_mig}/{benchmark_no_size}/mig-{benchmark_no_size}-{index}-{devices[3]} &
MIG_PID_3=$!

time CUDA_VISIBLE_DEVICES={gpu_id} ./mig >> /home/pabloh/2025/saidas/compute-{maquina}/gpu/{benchmark_no_size}/gpu-{benchmark_no_size}-{index}-{gpu_id}
GPU_PID_0=$!
time CUDA_VISIBLE_DEVICES={gpu_id} ./mig >> /home/pabloh/2025/saidas/compute-{maquina}/gpu/{benchmark_no_size}/gpu-{benchmark_no_size}-{index}-{gpu_id}
GPU_PID_1=$!
time CUDA_VISIBLE_DEVICES={gpu_id} ./mig >> /home/pabloh/2025/saidas/compute-{maquina}/gpu/{benchmark_no_size}/gpu-{benchmark_no_size}-{index}-{gpu_id}
