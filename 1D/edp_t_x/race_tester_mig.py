...
# cria as pastas caso não existam. Essa sequencia ficou meio ruim, mas da pra usar sem problema
    try:
        os.system(f'mkdir /home/ph4581/scripts_thiago/2D_imune_edema_pinn/1D/edp_t_x/lixeira/{tamanho_mig} -p')
        os.system(f'mkdir /home/ph4581/scripts_thiago/2D_imune_edema_pinn/1D/edp_t_x/saidas/{tamanho_mig} -p')
...
#PBS -o /home/ph4581/scripts_thiago/2D_imune_edema_pinn/1D/edp_t_x/lixeira/{tamanho_mig}/saida{i}.o
#PBS -e /home/ph4581/scripts_thiago/2D_imune_edema_pinn/1D/edp_t_x/saidas/{tamanho_mig}/tempo{i}.txt
